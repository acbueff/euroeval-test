...
#SBATCH --job-name=euroeval_german_test
...
RESULTS_DIR="/proj/berzelius-aiics-real/users/x_anbue/euroeval/results"
LOGS_DIR="/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs"
