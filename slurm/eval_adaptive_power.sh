...
#SBATCH --mem=64G
#SBATCH --time=8:00:00
#SBATCH --output=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/adp_pwr_%j.out
#SBATCH --error=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/adp_pwr_%j.err
...
ADP_PWR_DIR="/proj/berzelius-aiics-real/users/x_anbue/frodi_data/exp_checkpoints/exp_neurips_adaptive_power"
...
# ==================== Job Info ====================
echo "============================================================"
echo "GRPO + Adaptive Power Evaluation: iter_200, iter_300"
echo "============================================================"
echo "Job ID: $SLURM_JOB_ID"
echo "Node: $SLURMD_NODENAME"
echo "Start time: $(date)"
echo ""
echo "NOTE: iter_100 was not saved for this experiment"
echo ""
echo "Checkpoints to evaluate:"
echo "  - iter_200 (best_model): $ADP_PWR_DIR/best_model"
echo "  - iter_300 (final_model): $ADP_PWR_DIR/final_model"
echo "============================================================"
...
declare -a CHECKPOINTS=(
    "200,$ADP_PWR_DIR/best_model"
    "300,$ADP_PWR_DIR/final_model"
)
...
for item in "${CHECKPOINTS[@]}"; do
    IFS=',' read -r iteration checkpoint_path <<< "$item"
...
# Mapping: iteration -> checkpoint path
CHECKPOINTS = {
    200: f"{ADP_PWR_DIR}/best_model",
    300: f"{ADP_PWR_DIR}/final_model"
}
...
if not os.path.exists(EUROEVAL_RESULTS):
    ...
    for iteration, checkpoint_path in CHECKPOINTS.items():
        scores = {}
...
echo ""
echo "============================================================"
echo "Adaptive Power Evaluation Completed"
echo "============================================================"
echo "End time: $(date)"
echo ""
