...
#SBATCH --job-name=eval_bl_400_600
...
#SBATCH --output=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/bl_400_600_%j.out
#SBATCH --error=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/bl_400_600_%j.err
...
# ==================== Job Info ====================
echo "============================================================"
echo "GRPO Baseline* Evaluation: iter_400, 500, 600"
echo "============================================================"
...
echo "  - iter_400: $BASELINE_STAR_DIR/iter_400"
echo "  - iter_500: $BASELINE_STAR_DIR/iter_500"
echo "  - iter_600: $BASELINE_STAR_DIR/iter_600"
echo "============================================================"
...
for iteration in 400 500 600; do
    checkpoint_path="$BASELINE_STAR_DIR/iter_$iteration"
    
    echo ""
    echo "============================================================"
    echo "Evaluating: baseline_star iteration $iteration"
...
if not os.path.exists(EUROEVAL_RESULTS):
    ...
    for iteration in [400, 500, 600]:
        checkpoint_path = f"{BASELINE_STAR_DIR}/iter_{iteration}"
        scores = {}
        ...
        if scores:
            ...
            progress_data["runs"]["baseline_star"]["evaluations"][str(iteration)] = eval_data
            print(f"Updated baseline_star iter_{iteration}: {len(scores)} datasets, aggregate={aggregate:.2f}")
        else:
            print(f"No validation results found for baseline_star iter_{iteration}")
...
echo ""
echo "============================================================"
echo "Baseline* 400-600 Evaluation Completed"
echo "============================================================"
echo "End time: $(date)"
echo ""
