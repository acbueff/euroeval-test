...
#SBATCH --job-name=eval_bl_700_900
...
#SBATCH --output=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/bl_700_900_%j.out
#SBATCH --error=/proj/berzelius-aiics-real/users/x_anbue/euroeval/logs/bl_700_900_%j.err
...
# ==================== Job Info ====================
echo "============================================================"
echo "GRPO Baseline* Evaluation: iter_700, 800, 900"
echo "============================================================"
...
echo "  - iter_700: $BASELINE_STAR_DIR/iter_700"
echo "  - iter_800: $BASELINE_STAR_DIR/iter_800"
echo "  - iter_900: $BASELINE_STAR_DIR/iter_900"
echo "============================================================"
...
for iteration in 700 800 900; do
...
echo ""
echo "============================================================"
echo "Baseline* 700-900 Evaluation Completed"
echo "============================================================"
echo "End time: $(date)"
echo ""
